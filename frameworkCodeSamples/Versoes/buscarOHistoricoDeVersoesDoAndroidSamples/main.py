	...
	for arquivo in result:
		...
		for linhaDeLog in arquivoDeLog:
			...
			if (dadosParaInserirNaTabela[0] != objetoLog['caminho'] and (dadosParaInserirNaTabela[0] != '')):
				...
				versaoDoCommitAnterior = ""
				matriz.append(dadosParaInserirNaTabela)
				dadosParaInserirNaTabela = retornaVetorVazio()
			# else:
			...
			build = retornaArquivo("/home/gabriel/Documentos/ic/Samples/analiseDasImportacoes/analiseDeImportTotais/android/repositorios/" + objetoLog['caminho'])
			...
			elif dadosDaVersaoDoAndroid == '"android-O"' or dadosDaVersaoDoAndroid == "'android-O'":
				dadosDaVersaoDoAndroid = "26"
			elif dadosDaVersaoDoAndroid == "'android-L'" or dadosDaVersaoDoAndroid == '"android-L"':
				dadosDaVersaoDoAndroid = "21"
			elif dadosDaVersaoDoAndroid == '"android-N"' or dadosDaVersaoDoAndroid == "'android-N'":
				dadosDaVersaoDoAndroid = "24"

			# print(versaoDoCommitAnterior, dadosDaVersaoDoAndroid)

			if versaoDoCommitAnterior == "":
				versaoDoCommitAnterior = dadosDaVersaoDoAndroid
			elif versaoDoCommitAnterior != dadosDaVersaoDoAndroid and dadosDaVersaoDoAndroid != "'android-P'" and dadosDaVersaoDoAndroid != "'android-MNC'"and dadosDaVersaoDoAndroid != 'parent.ext.compileSdkVersion' and dadosDaVersaoDoAndroid != '"android-P"' and dadosDaVersaoDoAndroid != 'Integer.valueOf(project.TARGET_SDK_VERSION)' and dadosDaVersaoDoAndroid != 'androidCompileSdkVersion as Integer' and dadosDaVersaoDoAndroid != 'compileSdk' and dadosDaVersaoDoAndroid != '' and dadosDaVersaoDoAndroid != 'information not found' and dadosDaVersaoDoAndroid != 'rootProject.compileSdk' and dadosDaVersaoDoAndroid != '"android-MNC"' and dadosDaVersaoDoAndroid != 'rootProject.ext.compileSdkVersion':
...
def checkoutEmCommit(caminhoDoProjeto, hash):
	repo = Repo("/home/gabriel/Documentos/ic/Samples/analiseDasImportacoes/analiseDeImportTotais/android/repositorios/" + caminhoDoProjeto)		
