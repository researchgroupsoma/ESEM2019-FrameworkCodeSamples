...
dir_aux="/home/gabriel/Documentos/ic/analisandoOsForksComMaisDe10CommitsAhead"
dir="/home/gabriel/Documentos/ic/analisandoOsForksComMaisDe10CommitsAhead/repositorios/spring"
...
while read -r linha || [[ -n "$linha" ]] 
	do
		...
		#git log --name-status --stat --pretty=format:"$pasta;%h;%s" > $dir/$eco$pasta.txt #number of changes M A D
	...
	done < "$dir_aux/springForksAndHash.txt" 